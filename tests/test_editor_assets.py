...
class EditorAssetContractTests(unittest.TestCase):
    ...
    def test_editor_script_manifest_is_ordered_and_complete(self) -> None:
        self.assertEqual(
            ...
            (
                ...
                "msw-asset-core.js",
                "msw-audio-core.js",
                "msw-audio-actions-core.js",
                "msw-audio-render-core.js",
                ...
                "editor.js",
                "msw-media.js",
                "msw-media-analysis.js",
                "msw-range-selection.js",
                "msw-asr.js",
                "msw-persistence.js",
                "msw-processing.js",
                "msw-qwen-voices.js",
                "msw-index-tts.js",
                "msw-asset-library.js",
                "msw-tts.js",
    ...
    def test_sticker_root_uses_server_validation_without_browser_picker(self) -> None:
        ...
        self.assertIn("#sticker-root-modal { z-index: 510; }", styles)
