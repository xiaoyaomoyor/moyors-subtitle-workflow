...
The current version, **1.6.0-beta.3**, is MSW's own prerelease, based on the upstream release with the same version number. Equal version numbers do not imply identical features.
