...
datas = [
    ...
    (str(ROOT / "server-align" / "index.html"), "server-align"),
    (str(ROOT / "LICENSE"), "."),
    (str(ROOT / "THIRD_PARTY_NOTICES.md"), "."),
    (str(ROOT / "FAQ-常见问题.txt"), "."),
    (str(ROOT / "README-开始使用.txt"), "."),
    (str(ROOT / "blank-editor.html"), "."),
    (str(ROOT / "assets" / "maw.ico"), "assets"),
    (str(ROOT / "assets" / "msw-launcher.png"), "assets"),
    ...
    (str(ROOT / "generate_subtitle_doubao_api.py"), "local-runtime"),
    (str(ROOT / "maw" / "doubao.py"), "local-runtime/maw"),
    (str(ROOT / "maw" / "openai_asr_capabilities.py"), "local-runtime/maw"),
    ...
    (str(ROOT / "maw" / "msw" / "__init__.py"), "local-runtime/maw/msw"),
    (str(ROOT / "maw" / "msw" / "project_codec.py"), "local-runtime/maw/msw"),
    (str(ROOT / "maw" / "msw" / "subtitle_export.py"), "local-runtime/maw/msw"),
    ...
    (str(ROOT / "maw" / "env_config.py"), "ocr-runtime/maw"),
    (str(ROOT / "maw" / "msw" / "assets.py"), "ocr-runtime/maw/msw"),
    ...
    (str(ROOT / "maw" / "msw" / "__init__.py"), "ocr-runtime/maw/msw"),
    (str(ROOT / "maw" / "msw" / "project_codec.py"), "ocr-runtime/maw/msw"),
    (str(ROOT / "maw" / "msw" / "subtitle_export.py"), "ocr-runtime/maw/msw"),
